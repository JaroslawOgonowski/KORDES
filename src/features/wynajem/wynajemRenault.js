    ...
    <StyledSection>
      ...
      <Container>
        ...
        <Section>
          ...
          <List>
            <li>
              1–3 dni → <strong>290 zł/doba</strong>
            </li>
            <li>
              4–6 dni → <strong>270 zł/doba</strong>
            </li>
            <li>
              7–14 dni → <strong>240 zł/doba</strong>
            </li>
            <li>
        ...
        <Section>
          ...
          <List>
            ...
            <li>
              7–14 dni → <strong>250 zł/doba</strong>
            </li>
            <li>
              Powyżej 14 dni → <strong>220 zł/doba</strong>
            </li>
          </List>
          <PriceNote>
            📌 Stawka dobowa bez limitu kilometrów: <strong>600 zł</strong>
